		...
		<div class = "col-lg-12"><!-- col-lg-12 Begin -->
			...
			<ol class = "breadcrumb"><!-- breadcrumb Begin -->
				<li class = "active"><!-- active Begin -->
					<i class = "fa fa-dashboard"></i> <a href = "index.php?dashboard">Dasbor</a> > Masukkan Kategori
				</li><!-- active Finish -->
			...
			<div class = "panel panel-orange"><!-- panel panel-orange Begin -->
				<div class = "panel-heading"><!-- panel-heading Begin -->
					<h3 class = "panel-title"><!-- panel-title Begin -->
						<i class = "fa fa-money fa-fw"></i> Masukkan Kategori
				...
				<div class = "panel-body"><!-- panel-body Begin -->
					<form action = "" method = "post" class = "form-horizontal"><!-- form-horizontal Begin -->
						...
						<div class = "form-group"><!-- form-group Begin -->
							...
							<div class = "col-md-6"><!-- col-md-6 Begin -->
								<textarea name = "cat_desc" minlength = "5" cols = "19" rows = "6" class = "form-control"></textarea>
							</div><!-- col-md-6 Finish -->
						</div><!-- form-group Finish -->
						<div class = "form-group"><!-- form-group Begin -->
							<label class = "col-md-3 control-label"></label>
							<div class = "col-md-6"><!-- col-md-6 Begin -->
								<input name = "submit_cat" value = "Masukkan Kategori" type = "submit" class = "btn btn-warning form-control">
							</div><!-- col-md-6 Finish -->
						</div><!-- form-group Finish -->
...
<?php
	if(isset($_POST["submit_cat"])){
		...
		if($run_cat){
			echo "<script>alert('Kategori Telah Dimasukkan Dengan Sukses.')</script>";
