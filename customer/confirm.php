		...
		<div class = "container"><!-- container Begin -->
			...
			<div class = "col-md-9"><!-- col-md-9 Begin -->
				<div class = "box"><!-- box Begin -->
					<h1 align = "center"> Mohon konfirmasi pembayaran anda </h1>
					...
					<?php
						if(isset($_POST["confirm_payment"])){
							...
							$invoice_query = "SELECT invoice_no FROM customer_orders WHERE order_id = '$order_id'";
							...
							$amount_query = "SELECT due_amount FROM customer_orders WHERE order_id = '$order_id'";
							...
							if($pesan_error == ""){
								...
								$insert_payment = "INSERT INTO payments(invoice_no,amount,payment_mode,ref_no,code,payment_date,payment_image,payment_status) VALUES ";
								$insert_payment .= "('$invoice_no','$amount','$payment_mode','$ref_no','$code','$payment_date','$c_payment_new','$complete')";
